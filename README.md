...
**v0.3.0 will be the first full release**, there won't be a new feature to add after v0.2.18, once I believe all of the features are working properly, I will release v0.3.0.
